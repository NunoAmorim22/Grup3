...
function getClickedOccurrenceData(req,res){
    ...
    const query =connect.con.query ("SELECT o.id_occurrence, l.address, l.county, o.arrival_date, t.team_indicative, t.id_team  FROM Occurrence o, Request r, Location l, Team t WHERE  o.id_occurrence =? AND o.id_request=r.id_request AND r.id_location=l.id_location AND o.id_team=t.id_team", update, function(err, rows, fields){
        console.log(query.sql);
