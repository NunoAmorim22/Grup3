//funcao para atribuir as avaliacoes aos operacionais
...
function EditEvaluations() {
  ...
  //atribui cada data à respetiva rota e envia para o servidor através de um PUT
  fetch(
    `https://pspoperacionais.herokuapp.com/evaluations/occurrences/${id_occurrence}/refresh/${id_operational1}`,
    {
  ...
  fetch(
    `https://pspoperacionais.herokuapp.com/evaluations/occurrences/${id_occurrence}/refresh/${id_operational2}`,
    {
      headers: { "Content-Type": "application/json" },
      method: "PUT",
  ...
  fetch(
    `https://pspoperacionais.herokuapp.com/evaluations/occurrences/${id_occurrence}/refresh/${id_operational3}`,
    {
      headers: { "Content-Type": "application/json" },
      method: "PUT",
  ...
  fetch(
    `https://pspoperacionais.herokuapp.com/evaluations/occurrences/${id_occurrence}/refresh/${id_operational4}`,
    {
      headers: { "Content-Type": "application/json" },
      method: "PUT",
