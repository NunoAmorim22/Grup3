//Funcao para colocar os dados na pagina de avaliacoes e guardar os que sao necessarios para 
//depois atribuir acaliacoes
function refreshDadosAvaliacoes() {
  async function fetchAsync() {
    ...
    const response = await fetch(
      `https://pspoperacionais.herokuapp.com/evaluations/showteamids/${id_operational}`
    );
