function EditProfile() {
    ...
    data.email_operational = document.getElementById("emailEditar").value;
    data.name = document.getElementById("nomeEditar").value;
    palavraPass = document.getElementById("passwordEditar").value;
    rep_password = document.getElementById("rep_passwordEditar").value;
